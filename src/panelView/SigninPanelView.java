 ...
 */
public class SigninPanelView extends javax.swing.JPanel {
    private Main mainFrame;
    /**
     * Creates new form signinPanelView
     */
    ...
    public SigninPanelView(Main mainFrame) {
        this.mainFrame = mainFrame;
        initComponents();
        setColorComponent();
        
    }
    public SigninPanelView() {
        this(null);
    }
    ...
    private void initComponents() {
        ...
        setForeground(new java.awt.Color(26, 32, 44));
    ...
    private void signUpButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_signUpButtonMouseClicked
        if (mainFrame != null) {
        // Buat SignupPanelView baru dan pass reference Main juga
        SignupPanelView signupPanel = new SignupPanelView(mainFrame);
        mainFrame.setPanel(signupPanel);
    }
